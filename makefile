...
CFLAGS    = -Iheaders
HDR       = headers
OBJ       = ntc.o ntc_ht.o ntc_queue.o ntc_tools.o ntc_dyn.o ntc_net.o ntc_terminal.o
...
ntc.o: ntc.c $(addprefix $(HDR)/, ntc.h) $(addprefix $(HDR)/, ntc_ht.h) $(addprefix $(HDR)/, ntc_tools.h) $(addprefix $(HDR)/, ntc_queue.h) $(addprefix $(HDR)/, ntc_dyn.h) $(addprefix $(HDR)/, ntc_net.h) $(addprefix $(HDR)/, ntc_terminal.h)
